            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0"
                        ...
                        @if ($adminData->type == 1)
                            <img src="{{ !empty($adminData->profile_photo_path) ? url('upload/admin-images/' . $adminData->profile_photo_path) : url('upload/no_image.jpg') }}"
                                alt="">
                        @else
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('admin.profile') }}"><i
                                    class="ti-user text-muted mr-2"></i> Hồ sơ</a>
                            <a class="dropdown-item" href="{{ route('admin.change.password') }}"><i
                                    class="ti-wallet text-muted mr-2"></i> Đổi mật khẩu</a>
                            {{-- <a class="dropdown-item" href=""><i class="ti-settings text-muted mr-2"></i> Cài
                                đặt</a> --}}
