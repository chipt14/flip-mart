                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Mã: <strong id="pcode"></strong></li>
                                ...
                                <li class="list-group-item">Tình trạng: <span class="badge badge-pill badge-success"
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="submit" class="btn btn-primary mb-2" onclick="addToCart()">Thêm vào
                                giỏ</button>
                        </div>
                    </div>
                </div>
                        ...
                        miniCart += `<div class="cart-item product-summary">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                ...
                                                <div class="price">${value.price.toLocaleString()} ₫ * ${value.qty}</div>
                                            </div>
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        rows += `<tr>
                                    ...
                                    <td class="col-md-2">
                                        <button class="btn btn-primary icon" type="button" title="Thêm vào giỏ" data-toggle="modal" data-target="#exampleModal" id="${value.product_id}" onclick="productView(this.id)">Thêm vào giỏ</button>
                                    </td>
                    ...
                    if (data.total) {
                            ...
                            `<tr>
                                <th>
                                    <div class="cart-sub-total">
                                        Tổng tiền<span class="inner-left-md">${data.total}₫</span>
                                    </div>
                                    <div class="cart-grand-total">
                                        Tiền thanh toán<span class="inner-left-md">${data.total}₫</span>
                                    </div>
                                </th>
                            </tr>`
                        )
                        ...
                        $('#couponCalField').html(
                            `<tr>
                                <th>
                                    <div class="cart-sub-total">
                                        Tổng tiền<span class="inner-left-md">${data.subtotal}₫</span>
                                    </div>
                                    <div class="cart-sub-total">
                                    ...
                                    <div class="cart-sub-total">
                                        Chiết khấu<span class="inner-left-md">${data.discount_amount}₫</span>
                                    </div>
                                    <div class="cart-grand-total">
                                        Tiền thanh toán<span class="inner-left-md">${data.total_amount}₫</span>
                                    </div>
                                </th>
                            </tr>`
                        )
