    ...
    <div class='container'>
        <div class='row'>
            ...
            <div class='col-md-9'>
                ...
                <h4><b>Tổng số tìm kiếm </b><span class="badge badge-danger" style="background: #FF0000;">
                        {{ count($products) }} </span> sản phẩm </h4>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        ...
                                                        @else
                                                            <div class="product-price"> <span class="price">
                                                                {{ number_format($product->discount_price) }}₫ </span> <span
