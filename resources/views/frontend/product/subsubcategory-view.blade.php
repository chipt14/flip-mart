        ...
        <div class='row'>
            ...
            <div class='col-md-9'>
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"> <img src="frontend/assets/images/banners/cat-banner-1.jpg" alt=""
                ...
                @foreach ($breadsubsubcat as $item)
                    <span class="badge badge-danger" style="background: #FF0000">{{ $item->subsubcategory_name }}
                    </span>
                @endforeach
                                                    ...
                                                    <div class="col col-sm-8 col-lg-8">
                                                        <div class="product-info">
                                                            ...
                                                            <div class="description m-t-10">
                                                                {{ strip_tags($product->short_descp) }}</div>
                                                            <div class="cart clearfix animate-effect">
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        <li class="add-cart-button btn-group">
            ...
            <div class="logo-slider-inner">
                <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                    <div class="item m-t-15"> <a href="#" class="image"> <img
                                ...
                                src="frontend/assets/images/blank.gif" alt=""> </a> </div>
                    <!--/.item-->
