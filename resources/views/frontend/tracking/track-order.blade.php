...
<div class="container">
    <article class="card">
        <header class="card-header"> <b>Theo dõi đơn hàng</b> </header>
        <div class="card-body">
            ...
            <div class="track">
                @if ($track->status == 'pending')
                    ...
                    <div class="step">
                        ...
                        <span class="text">Đã lấy hàng</span>
                    </div>
                    <div class="step">
                        <span class="icon">
                            <i class="fa fa-check"></i>
                ...
                @elseif($track->status == 'confirm')
                    ...
                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">
                            Chờ lấy hàng </span> </div>

                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                            class="text">Đã lấy hàng</span> </div>

                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                            class="text">Đã vận chuyển </span> </div>

                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                            class="text">Giao thành công </span> </div>
                @elseif($track->status == 'processing')
                    ...
                    <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                            class="text"> Chờ lấy hàng </span> </div>
